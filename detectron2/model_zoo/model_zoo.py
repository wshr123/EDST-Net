...
def get_config_file(config_path):
    ...
    #     "detectron2", os.path.join("configs", config_path)
    # )
    # print(cfg_file)
    cfg_file = "/media/zhong/1.0T/zhong_work/SlowFast/Detectron2/configs/COCO-Detection/faster_rcnn_R_50_FPN_3x.yaml"
