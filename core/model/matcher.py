...
from core.utils.box_ops import box_cxcywh_to_xyxy, generalized_box_iou
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets, group_detr=1):
        ...
        # Compute the giou cost betwen boxes ava dataset:xyxy
...
def build_matcher(cfg):
    return HungarianMatcher(
        cost_class=cfg.LOSS.CLS_LOSS_COEF,
        cost_bbox=cfg.LOSS.BBOX_LOSS_COEF,
        cost_giou=cfg.LOSS.GIOU_LOSS_COEF,
