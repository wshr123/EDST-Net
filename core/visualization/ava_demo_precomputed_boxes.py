...
import torch
import tqdm
from core.dataset.ava_helper import parse_bboxes_file
from core.dataset.cv2_transform import scale, scale_boxes
from core.dataset.utils import get_sequence
...
class AVAVisualizerWithPrecomputedBox:
    ...
    def get_predictions(self):
        ...
        model, cretiron, postprocesser = build(self.cfg)
        model.eval()
